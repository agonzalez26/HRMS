...
public class Guest extends Operator {
	...
	private String lastName; /*
								 * The last name of the guest staying at the hotel.
								 */
	private String address; /*
							 * The street address of the guest staying at the
							 * hotel
							 */
	private String email; /*
							 * The email address of the guest staying at the
							 * hotel.
							 */
	private String phoneNumber; /*
								 * The phone number of the guest staying at the
								 * hotel
								 */
	private int age; // age of the guest
	private int id; /* The guest ID of the guest staying at the hotel. */
	// private int confirmationNumber; /*The confirmation number of the guest
	// staying at the hotel*/
	// The idea of a confirmation number isnt needed if we have reservation IDs
	// In the instance of having multiple reservations for one guest, we can
	// have multiple reservation IDs
	// assigned to a guest instead of one confirmation number which has the
	// different reservation IDs
	// assigned to it anyways (inefficient)
	private int amountOfReservations; // the number of reservations that the
										// person has
	private List<Reservation> reservationList; // The reservations assigned to
												// that guest

...
public class Guest extends Operator {
    ...
    /*The first name of the guest at the hotel*/
    private String lastName;
    /*The last name of the guest staying at the hotel.*/
    private String address;
    /*The street address of the guest staying at the hotel*/
    private String email;
    /*The email address of the guest staying at the hotel.*/
    private String phoneNumber;
    /*The phone number of the guest staying at the hotel*/
    private int age;		//age of the guest
    private int id;
    /*The guest ID of the guest staying at the hotel.*/

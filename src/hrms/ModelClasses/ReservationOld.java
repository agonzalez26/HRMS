...
public class ReservationOld {
	...
	private BillOld totalAmount; /*Bill total amount*/
	private GuestOld guestHolder; /*guest that has reservation*/
    private List<RoomOld> roomList; /*list of rooms for the reservation*/

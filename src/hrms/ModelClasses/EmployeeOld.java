...
public class EmployeeOld extends OperatorOld{
	private int employeeId; /*employee id*/
	private boolean EmpOrManFlag; /*determines if a general employee or manager*/
	private List<RoomOld> roomsList; /*list of rooms at the hotel*/
	private List<AmenityOld> amenitiesList; /*list of amenities at the hotel*/
	private List<ReservationOld> reservationsList; /*list of reservations at hotel*/

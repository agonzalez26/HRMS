...
//                        // load up OTHER FXML document
////                        root = FXMLLoader.load(HRMS.class.getResource("View/EmployeeView.fxml"));
//                        FXMLLoader fxLoader = new FXMLLoader(HRMS.class.getResource("View/EmployeeView.fxml"));
//                        root = (Parent) fxLoader.load();
//                        EmployeeViewController controller = fxLoader.<EmployeeViewController>getController();
...
////                        controller.setEmployee(id);
////
////                    } else if (id.equals("0000") && password.equals("0000")) {
////                        // get reference to the button's stage
////                        stage = (Stage) nextButton.getScene().getWindow();
////                        // load up OTHER FXML document
//////					root = FXMLLoader.load(HRMS.class.getResource("View/EmployeeView.fxml"));
